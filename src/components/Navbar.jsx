...
export default function Navbar() {
    ...
    const linkClass = (path) =>
        `block relative font-semibold text-sm tracking-[0.1em] uppercase transition-all ${
            isActive(path)
        ...
        <nav className="relative z-20 w-full bg-transparent">
            ...
            <div className="flex items-center justify-between px-5 sm:px-8 lg:px-12 py-5 sm:py-7">
                ...
                <Link to="/" className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-magazine-cyan text-[10px] sm:text-xs tracking-[0.2em] font-medium uppercase drop-shadow-[0_0_5px_rgba(0,229,255,0.8)] mt-0.5">Revista Digital</span>
                    </div>
                </Link>
            ...
            {mobileOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 bg-[#040d1a]/95 backdrop-blur-md border-t border-white/10 z-30 px-6 py-6 flex flex-col gap-5 shadow-[0_10px_40px_rgba(0,0,0,0.7)]">
                    ...
                    <a href="#autores" className="text-gray-300 text-sm tracking-[0.1em] uppercase font-medium" onClick={() => setMobileOpen(false)}>AUTORES</a>
